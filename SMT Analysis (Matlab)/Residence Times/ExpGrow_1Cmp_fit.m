function [Esp_Coef, Esp_Sigma Esp_Fit,resNorm] = ExpGrow_1Cmp_fit(data, k0s, range);
...
fitfun = @(COEF) (ExpGrow_1Cmp_fun(COEF, tlist)) - (Y);
...
% Compute output
Esp_Fit(:,1) = data(:,1);
Esp_Fit(:,2) = ExpGrow_1Cmp_fun(Esp_Coef, data(:,1));
