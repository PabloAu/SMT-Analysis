...
import fiji.plugin.trackmate.features.spot.SpotIntensityMultiCAnalyzer as SpotIntensityMultiCAnalyzer
...
#Directo
Folder = '//pasteur/SysBC-Home/vagade/Desktop/Working directory/Analysed Images/Over expressed/B3/Tiff Images/';
OutFolfer = '//pasteur/SysBC-Home/vagade/Desktop/Working directory/Analysed Images/Over expressed/B3/Tiff Images/Output folder/';
...
Pixel_size = 0.145; #Space units are in microns.
Frame_interval = 0.008; #Time units are in seconds.
...
Analyze_tracks = 0; #Binary decision. 1 for inclusing the feature analysis of the tracks to the module.
Export_spot_statistics = 0; #Binary decision. 1 for exporting the spot statistics table as a .csv file. **If you want to export the spot statistics, Analyze_tracks variable must be equal to 1**

#Localization
Subpixel_localization = True;
Median_filtering = True;
Spot_radius = 0.35; #Units are in microns
Intensity_threshold = 0.; #Choose between Intensity of Quality thresholds. Quality works better since it takes into account the SNR of each rather than only its raw intensity value.
...
Track_merging = False;
Gap_closing = True;
Max_jump = 0.3; #Max jump from frame to frame. Units are in microns.
Gap_closing_distance = 0.1; #Maximum spatial distance when closing a GAP. Units are in microns.
...
#......................................................PROCESSING................................................#
#................................................................................................................#
ROI_list_temp = sorted(os.listdir(Folder_ROIs));
ROI_list = [];

for names in ROI_list_temp:
	if (names.endswith(".roi") or names.endswith(".zip")):
		ROI_list.append(names);
...
for filename in sorted(os.listdir(Folder)):
	if filename.endswith(extension):
		...
		for idx in range(total_rois):
			...
			#settings.setFrom(imp); Old TrackMate version way
			...
			filter1 = FeatureFilter('QUALITY', Quality_threshold, True);
